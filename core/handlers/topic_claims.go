...
func (h *Handler) AddTopicToCluster(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.store.SaveClusterTopic(r.Context(), &ct); err != nil {
...
// 	}
// 	clusterName := parts[0]
// 	log.Printf("[ClusterTopicHandler] Listing topics from %v", clusterName)
