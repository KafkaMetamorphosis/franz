...
Status: ⬜ not started
Depends on: [02](./02-domain-foundations.md) · [03](./03-kafka-cluster.md) · [09](./09-kafka-topic.md) · [10](./10-async-channel.md) · [13](./13-telemetry-ingest.md)
...
actions wait on [17](./17-migration-and-data-movement.md)** — everything else
ships here.
